...
data = np.array([ts_obj.getFirstFifteenMinutesGold() for ts_obj in normalized_time_series_objects])
...
# Initialize and train the kNN classifier with k=1
...
print(f"Accuracy with 1 neighbor: {accuracy}")
print()
